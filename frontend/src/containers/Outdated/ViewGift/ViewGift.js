...
import { ViewerVR } from "components/Outdated/ViewerVR";
import { ViewerAR } from "components/Outdated/ViewerAR";
import { Marker } from "components/Outdated/Marker";
...
const View = props => {
  ...
  React.useEffect(() => {
    // Send guid (part of current URL: https://e-gifts.site/outdated/view/<guid>)
    // Recieve GLTF model URL and some properties
    // Text is optional
    axios
